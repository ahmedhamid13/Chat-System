...
class ChatTest < ActiveSupport::TestCase
  ...
  # test "should not save chat without number" do
  #   application = SystemApplication.new(name: "name", token: "token")
  #   application.save
  #   chat = Chat.new(system_application: application)
  #   assert_not chat.save, "Saved the chat without a number"
  # end
